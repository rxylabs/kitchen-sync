...
var Order = React.createClass({
  ...
  toggleOrderStatus: function toggleOrderStatus() {
    this.props.toggleOrderStatus(this.props.orderID);
  },

  handleOrderDelete: function handleOrderDelete() {
        ...
        this.props.orders.map(function (order) {
          if (!order.ready) {
            return React.createElement(Order, {
              ...
              toggleOrderStatus: _this.props.toggleOrderStatus,
              handleOrderDelete: _this.props.handleOrderDelete
            });
          }
        })
      ),
...
var KitchenSyncApp = React.createClass({
  ...
  _setOrderState: function _setOrderState(orders) {
    this.setState({ orders: orders });
  },

  toggleOrderStatus: function toggleOrderStatus(orderID) {
    var orders = this.state.orders;

    var updatedOrders = orders.map(function (m) {
      if (m.id === orderID) {
        m.ready = !m.ready;
      }
      return m;
  ...
  handleOrderDelete: function handleOrderDelete(orderID) {
    var orders = this.state.orders;
...
React.render(React.createElement(KitchenSyncApp, null), document.getElementById('app'));
